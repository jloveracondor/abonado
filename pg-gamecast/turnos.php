<div class="row text-center py-4">
	...
	<div class="col-5 my-auto ab-equipos-logos"><img src="assent/img/LVBP/leones-del-caracas 1.png"> NDM <span class="ab-carreras"> 0</span></div>
</div>
<div class="row  mx-2">
...
<div class="row px-3 my-2 border-bottom-gamecast">
	...
	<div class="col-4 col-lg-4 col-md-5 my-auto"><span class="ab-bat-pit"> PITCHEANDO</span> <br> <span class="ab-nombre-jugador-game">Tarik Skubal</span> <br><span><b>LDC</b> • LHP</span></div>
	<div class="col-4 col-lg-5 col-md-3 my-auto ab-avg">1.1 IP (32P 19S), 5.40 ERA</div>
</div>
