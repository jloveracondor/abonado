<div class="container-fluid container-ab" id="ab-resultados-page">
	...
	<div class="row">
		<div id="finalizados" class="col-md-6  col-lg-6 col-xl-4 col-12 col-sm-12 pl-md-1 pr-md-1 my-1">
						...
						<div class="row ab-encabezados">
							...
							<div class="col-4 col-md-3">
								<div class="row">
									...
									<div class="col-4 text-center">H</div>
									<div class="col-4 text-center">E</div>
								</div>
							</div>
						</div>
						<div class="row ab-equipo1">
							<div class="col-8 col-md-9">
								<div class="row ab-ganador">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">MIA</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span>
									</div>
								</div>
							</div>
							<div class="col-4 col-md-3">
								<div class="row h-100">
									<div class="col-4 text-center bg-gris-tablas ab-resultados-finales1">5</div>
						...
						<div class="row ab-equipo2">
							<div class="col-8 col-md-9">
								<div class="row">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">NYM</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span> </div>
								</div>
							</div>
							<div class="col-4 col-md-3">
								<div class="row">
									<div class="col-4 text-center bg-gris-tablas ab-resultados-finales2">5</div>
									<div class="col-4 text-center">8</div>
									<div class="col-4 text-center">0</div>
								</div>
							</div>
		...
		<div id="iniciados" class="col-md-6  col-lg-6 col-xl-4 col-12 col-sm-12 pl-md-1 pr-md-1 my-1">
			<div class="ab-table-resultados px-md-2 px-0 h-100">
				<div class="separador-lateral">
				<div class="row ab-status ">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">CHC</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span>
									</div>
								</div>
							</div>
							<div class="col-4 col-md-3">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">PIT</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span> </div>
								</div>
							</div>
							<div class="col-4 col-md-3">
								<div class="row">
				...
				<div class="row ab-jugadores">
					...
					<div class="col-lg-6 col-md-6 col-xl-6 col-6 text-right">
						<div class="row">
							<div class="col-12 gris-claro">
								BAT • P
							</div>
				...
				<div class="row ab-equipos">
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-4 col-md-3">
								<div class="row h-100">
									<div class="col-4 text-center">15</div>
									<div class="col-4 text-center">8</div>
									<div class="col-4 text-center">0</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-4 col-md-3">
								<div class="row">
									<div class="col-4 text-center">25</div>
									<div class="col-4 text-center">8</div>
									<div class="col-4 text-center">0</div>
								</div>
							</div>
		...
		<div id="pospuesto" class="col-md-6  col-lg-6 col-xl-4 col-12 col-sm-12 pl-md-1 pr-md-1 my-1">
			<div class="ab-table-resultados px-md-2 px-0 h-100">
				<div class="separador-lateral">
				<div class="row ab-status ">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">OAK</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span>
									</div>
								</div>
							</div>
							<div class="col-4 col-md-3">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									...
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">SEA</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">15 - 15 ( Vis: 2 - 1 ) </span> </div>
								</div>
							</div>
							<div class="col-4 col-md-3">
								<div class="row">
				...
				<div class="row ab-jugadores">
					<div class="col-12 text-center">
						<h6 class="gris-oscuro font-weight-bold">PITCHERS  PROBABLES</h6>
					</div>
					<div class="col-lg-6 col-md-6 col-xl-6 col-6">
						<div class="row">
				...
				<div class="row ab-status-final">
					<div class="col-md-12">
						<span class="gris-claro font-weight-bold">Movido al 14 SEP • COVID-19</span>
					</div>
				</div>
			</div>
			</div>
		</div>
		<div id="programado" class="col-md-6  col-lg-6 col-xl-4 col-12 col-sm-12 pl-md-1 pr-md-1 my-1">
			<div class="ab-table-resultados px-md-2 px-0 h-100">
				<div class="separador-lateral">
				<div class="row ab-status ">
					...
					<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									<div class="col-2 ab-img-equipo"><img src="/abonado/assent/img/equipos/Oakland 1.png" alt=""></div>
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">OAK</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">14 - 22 ( Vis: 5 - 13 ) </span>
									</div>
								</div>
							</div>
							<div class="col-4 col-md-3">
						...
						<div class="row">
							<div class="col-8 col-md-9">
								<div class="row">
									<div class="col-2 ab-img-equipo"><img src="/abonado/assent/img/equipos/Seattle 1.png" alt=""></div>
									<div class="col-10 ab-tabla-equipo"><span class="font-weight-bold gris-oscuro ab-equipos-box">SEA</span> <br class="d-block d-sm-none"> <span class="ab-resultados-box">27 - 10 ( Casa: 12 - 5 ) </span> </div>
								</div>
							</div>
							<div class="col-4 col-md-3">
								<div class="row">
				...
				<div class="row ab-status-final">
					<div class="col-md-12">
						<span class="gris-claro font-weight-bold">Por empezar</span>
					</div>
				</div>
			</div>
			</div>
