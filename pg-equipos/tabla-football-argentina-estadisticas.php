	...
	<div class="tab-content" id="nav-tabContent">
		...
		<div class="col"> 
			<div class="col rounded border table-responsive">
				<!-- <p class="ab-title-liga">FIFA World Cup 2022 Qualifiers - COMMEBOL <img src="/abonado/assent/img/fifa2022.png" style="max-width: 42px;"alt=""></p> -->
              ...
              <th></th>
							...
							<th scope="col"> DG </th>
							<th scope="col"></th>
							<th class="ab-average" scope="col" data-toggle="tooltip" data-placement="top" title="Puntos Acumulados"> PTS </th>
              <th scope="col"></th>
            ...
            <!-- start tr-->
						<tr>
              <td class="jsutify-content-center"> <img src="/abonado/assent/img/fifa2022.png" alt="">FIFA World Cup </td>
							<td>2020 - 2022</td>
							<td></td>  <!-- Aquí 2da-->
							<td>5</td>
							<td></td>
              ...
              <td>1</td>
              <td></td>
              <td class="ab-average-fondo">20</td>
              <td></td>
            </tr>
            <!-- end tr -->
                        <!-- start tr-->
						<tr>
              <td class="jsutify-content-center"><img src="/abonado/assent/img/america.png" alt="">Copa América</td>
							<td>2019</td>
							<td></td>  <!-- Aquí 2da-->
							<td>5</td>
							<td></td>
